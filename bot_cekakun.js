...
async function startGlobalBrowser() { // <--- (1) Kurung Buka Fungsi
    console.log(`\x1b[33m[PROCESS]\x1b[0m Memulai global Chromium instance...`);
    try { // <--- (2) Kurung Buka Try
        globalBrowser = await chromium.launch({ // <--- (3) Kurung Buka Config
            headless: true, 
            args: [
