...
const KAMUS_HOLD_PAYMENT = [
    ...
    'อัปเดตการชำระเงิน', 'cập nhật thanh toán', 'actualiza la información de pago',
    'atualizar a forma de pagamento', 'mettre à jour les informations de paiement',
    'zahlungsart aktualisieren', 'metodo di pagamento', 'päivitä maksutiedot',
    'zaktualizuj metodę płatności', 'aktualizovat platbu', 'fizetés frissítése',
    'actualizează plata', 'обновите способ оплаты', 'お支払い方法の更新',
    '결제 수단 업데이트', '更新您的付款方式', 'تحديث طريقة الدفع',
    'contact your provider', 'temporary hold', 'start watching again',
    'hubungi penyedia', 'ditahan sementara', 'comunícate con tu proveedor', 'suspensión temporal',
...
const KAMUS_GEO_LOCK = [
    ...
    'ไม่มีให้บริการในภูมิภาค', 'ไม่ได้อยู่ในครัวเรือน', 'không khả dụng ở khu vực', 'không thuộc hộ gia đình',
    'no disponible en esta región', 'no es parte del hogar', 'não está disponível nesta região', 'não faz parte da residência',
    'pas disponible dans cette région', 'ne fait pas partie du foyer', 'in dieser region nicht verfügbar', 'nicht teil des netflix-haushalts',
    'non è disponibile in questa regione', 'non fa parte del nucleo domestico', 'niet beschikbaar in deze regio',
    'inte tillgängligt i denna region', 'inte del av netflix-hushållet', 'ikke tilgængeligt i denne region', 'ikke en del af netflix-husstanden',
    'ei saatavilla tällä alueella', 'ei kuulu netflix-kotitalouteen', 'bu bölgede kullanılamıyor', 'netflix hanesine dahil değil',
    'niedostępny w tym regionie', 'není v tomto regionu k dispozici', 'ebben a régióban nem elérhető',
    'indisponibil în această regiune', 'недоступно в этом регионе',
...
// --- SETUP BROWSER (UDAH FIX HEADLESS & TRY-CATCH, HANYA 1 FUNGSI) ---
